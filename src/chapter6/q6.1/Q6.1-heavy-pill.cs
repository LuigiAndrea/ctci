...
namespace Chapter6
{
    public static class Q6_1HeavyPill
    {
        ...
        {
            private double totalNormalWeight;
            private double totalSpecialWeight;
            private double diffWeight;

            public void SetHeavyPillProblem(Pill p, int numberBottles, int heavyBottle)
            {
            ...
            public double GetHeavyBottle() => (diffWeight != 0)
