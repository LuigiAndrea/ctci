...
namespace Tests.Chapter2
{
    ...
    class TestDataIntersection
    {
        ...
        {
            Singly l1 = buildLinkedListNodeFromArray<Singly>(new int[6] { 9, 3, 1, 1, 7, 7 });
            Singly l2 = buildLinkedListNodeFromArray<Singly>(new int[3] { 1, 1, 1 });
            l2.next.next.next = l1.next;
            Singly l1_1 = buildLinkedListNodeFromArray<Singly>(new int[2] { 9, 3 });
            Singly l2_2 = buildLinkedListNodeFromArray<Singly>(new int[1] { 1 });
            l2_2.next = l1_1.next;
        ...
        {
            Singly l1 = buildLinkedListNodeFromArray<Singly>(new int[2] { 9, 3 });
            Singly l2 = buildLinkedListNodeFromArray<Singly>(new int[2] { 1, 3 });

            Singly l1_1 = buildLinkedListNodeFromArray<Singly>(null);
            Singly l2_2 = buildLinkedListNodeFromArray<Singly>(new int[2] { 1, 3 });

            Singly l1_3 = buildLinkedListNodeFromArray<Singly>(null);
            Singly l2_3 = buildLinkedListNodeFromArray<Singly>(null);

            Singly l1_4 = buildLinkedListNodeFromArray<Singly>(new int[0] { });
            Singly l2_4 = buildLinkedListNodeFromArray<Singly>(new int[0] { });
